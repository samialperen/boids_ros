...
class ReynoldsController(object):
    ...
    def callback(self, *data):
        ...
        if self.params_set:
            ...
            ret_vel, viz = self.agent.compute_velocity(my_agent, nearest_agents, obstacles,rel2leader)
            ...
            #if self.enable_leader_following:
                #rospy.loginfo("Leader following is activated")
    ...
    #def leader_callback(self, leader_data):        
    #    self.leader = leader_data.pose
    #    print("subscribed leader")
    #    print(self.leader)
    ...
    def __init__(self):
        ...
        #self.leader = Pose() ## We will get leader pose through second callback
        ...
        subs = [mf.Subscriber("nearest", OdometryArray), mf.Subscriber("avoid", PoseArray) \
                ,mf.Subscriber("rel2leader", PoseArray) ]
                #,mf.Subscriber("leader", PoseStamped) ]
